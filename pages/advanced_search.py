...
class Advanced_page(Base_page):
    ...
    def enter_keywords_or_item_number(self):
        self.driver.find_element(*self.ENTER_KEYWORDS_OR_ITEM_NUMBER).send_keys("iphone")
    ...
    def exclude_words_from_search(self):
        self.driver.find_element(*self.EXCLUDE_WORDS_FROM_SEARCH).send_keys("iphone 9")
